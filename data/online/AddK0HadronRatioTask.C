AliAnalysisTaskK0HadronRatio* AddK0HadronRatioTask(
  ...
  AliAnalysisTaskK0HadronRatio* task = new AliAnalysisTaskK0HadronRatio(name.Data());
  ...
  manage->ConnectOutput(task, 1, manage->CreateContainer("h-K0", TList::Class(), AliAnalysisManager::kOutputContainer, file_name.Data()));
