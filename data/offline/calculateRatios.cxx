...
void calculateRatios(TString input_0_20 = "", TString input_20_50 = "", TString input_50_100 = "", TString scaleSuffix = "avgscale", Int_t bgMethod=0){
    ...
    TString outputstring = "kaon_hadron_ratios";
    ...
    if(input_0_20.EqualTo("")) input_0_20 = "US_syst_trig_4_8_assoc_2_4_cent_0_20_mixcorr_hKaon.root";
    if(input_20_50.EqualTo("")) input_20_50 = "US_syst_trig_4_8_assoc_2_4_cent_20_50_mixcorr_hKaon.root";
    if(input_50_100.EqualTo("")) input_50_100 = "US_syst_trig_4_8_assoc_2_4_cent_50_100_mixcorr_hKaon.root";

    TH1D* hhdphi_0_20 = getHisto("trig_4_8_assoc_2_4_cent_0_20_mixcorr_hKaon.root", "hh", "hh2D", "Eff_0_20", -1.2, 1.2, kBlue+2, 21);
    TH1D* hKaondphi_0_20 = getHisto(input_0_20, "hKaon", Form("RSUSsubhKaon2Dpeak%s", scaleSuffix.Data()), "Eff_0_20", -1.2, 1.2, kRed+2, 22);


    //scale for inv. mass range
    //hKaondphi_0_20->Scale(1.0/0.897); //wide mass
    //hKaondphi_0_20->Scale(1.0/0.803); //narrow mass

    TF1 *corrFit = setupFit("corrFit", hhdphi_0_20, kBlue, 7, bgMethod);
    TF1 *corrFit2 = setupFit("corrFit2", hKaondphi_0_20, kRed, 7, bgMethod);

    hhdphi_0_20->Fit("corrFit", "R0");
    hKaondphi_0_20->Fit("corrFit2", "R0");
    ...
    TF1 *hKaonBG = new TF1("hKaonBG", "pol0(0)", -TMath::Pi()/2.0, 3.0*TMath::Pi()/2.0);
    hKaonBG->SetParLimits(0, 0.00001, 10000000.0);
    hKaonBG->SetParameter(0, 1.0*corrFit2->GetParameter(6));
    hKaonBG->SetLineStyle(2);

    Double_t near0_20hKaonError = 0;
    Double_t near0_20hhError = 0;
    Double_t away0_20hKaonError = 0;
    Double_t away0_20hhError = 0;
    //Double_t mid0_20hKaonError =(1.0/3.0)*TMath::Sqrt(TMath::Power(hKaondphi_0_20->GetBinError(8),2) + TMath::Power(hKaondphi_0_20->GetBinError(16),2) + TMath::Power(hKaondphi_0_20->GetBinError(1),2));
    Double_t mid0_20hKaonError = corrFit2->GetParError(6);
    ...
    Double_t total0_20hKaonError;
    Double_t total0_20hhError = 0;

    Double_t near0_20hKaonYield = hKaondphi_0_20->IntegralAndError(1,8,near0_20hKaonError, "width") - hKaonBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(1), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(8));
    //near0_20hKaonError = TMath::Sqrt(TMath::Power(near0_20hKaonError, 2) + TMath::Power(6.0*mid0_20hKaonError, 2));
    Double_t near0_20hhYield = hhdphi_0_20->IntegralAndError(1,8,near0_20hhError, "width") - hhBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(1), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(8));
    //near0_20hhError = TMath::Sqrt(TMath::Power(near0_20hhError, 2) + TMath::Power(6.0*mid0_20hhError, 2));
    Double_t away0_20hKaonYield = hKaondphi_0_20->IntegralAndError(9,16,away0_20hKaonError, "width") - hKaonBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(9), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(16));
    //away0_20hKaonError = TMath::Sqrt(TMath::Power(away0_20hKaonError, 2) + TMath::Power(8.0*mid0_20hKaonError, 2));
    Double_t away0_20hhYield = hhdphi_0_20->IntegralAndError(9,16,away0_20hhError, "width")- hhBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(9), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(16));
    //away0_20hhError = TMath::Sqrt(TMath::Power(away0_20hhError, 2) + TMath::Power(8.0*mid0_20hhError, 2));
    Double_t total0_20hKaonYield = hKaondphi_0_20->IntegralAndError(1,16,total0_20hKaonError, "width");
    Double_t total0_20hhYield = hhdphi_0_20->IntegralAndError(1,16,total0_20hhError, "width");
    Double_t mid0_20hKaonYield = hKaonBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(1), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(16));
    mid0_20hKaonError = mid0_20hKaonError*16.0;
    Double_t mid0_20hhYield = hhBG->Integral(hKaondphi_0_20->GetXaxis()->GetBinLowEdge(1), hKaondphi_0_20->GetXaxis()->GetBinUpEdge(16));
    mid0_20hhError = mid0_20hhError*16.0;
    Double_t jet0_20hKaon = hKaondphi_0_20->Integral(1, 16) - mid0_20hKaonYield;
    Double_t jet0_20hh = hhdphi_0_20->Integral(1, 16) - mid0_20hhYield;

    Double_t near020 = near0_20hKaonYield/near0_20hhYield;
    Double_t near020Er = near020*TMath::Sqrt(TMath::Power(near0_20hKaonError/near0_20hKaonYield, 2) + TMath::Power(near0_20hhError/near0_20hhYield, 2));
    Double_t away020 = away0_20hKaonYield/away0_20hhYield;
    Double_t away020Er = away020*TMath::Sqrt(TMath::Power(away0_20hKaonError/away0_20hKaonYield, 2) + TMath::Power(away0_20hhError/away0_20hhYield, 2));
    Double_t mid020 = mid0_20hKaonYield/mid0_20hhYield;
    Double_t mid020Er = mid020*TMath::Sqrt(TMath::Power(mid0_20hKaonError/mid0_20hKaonYield, 2) + TMath::Power(mid0_20hhError/mid0_20hhYield, 2));
    Double_t total020 = total0_20hKaonYield/total0_20hhYield;
    Double_t total020Er = total020*TMath::Sqrt(TMath::Power(total0_20hKaonError/total0_20hKaonYield, 2) + TMath::Power(total0_20hhError/total0_20hhYield, 2));

    TH1D *ratios020 = new TH1D("ratios020", "(h-#Kaon^{0} / h-h) Ratios", 4, 0, 4);
    ...
    paperfit020->SetParameter(0, hKaonBG->GetParameter(0));


   //20-50 section
    TH1D* hhdphi_20_50 = getHisto("trig_4_8_assoc_2_4_cent_20_50_mixcorr_hKaon.root", "hh", "hh2D", "Eff_20_50", -1.2, 1.2, kBlue+2, 21);
    TH1D* hKaondphi_20_50 = getHisto(input_20_50, "hKaon", Form("RSUSsubhKaon2Dpeak%s", scaleSuffix.Data()), "Eff_20_50", -1.2, 1.2, kRed+2, 22);


    //scale for inv. mass range
    //hKaondphi_20_50->Scale(1.0/0.897); //wide mass
    //hKaondphi_20_50->Scale(1.0/0.803); //narrow mass

    TF1 *corrFit2050 = setupFit("corrFit2050", hhdphi_20_50, kBlue, 7, bgMethod);

    TF1 *corrFit2_2050 = setupFit("corrFit2_2050", hKaondphi_20_50, kRed, 7, bgMethod);

    hhdphi_20_50->Fit("corrFit2050", "R0");
    hKaondphi_20_50->Fit("corrFit2_2050", "R0");
    ...
    TF1 *hKaonBG_20_50 = new TF1("hKaonBG_20_50", "pol0(0)", -TMath::Pi()/2.0, 3.0*TMath::Pi()/2.0);
    hKaonBG_20_50->SetParLimits(0, 0.00001, 10000000.0);
    hKaonBG_20_50->SetParameter(0, 1.0*corrFit2_2050->GetParameter(6));
    hKaonBG_20_50->SetLineStyle(2);

    Double_t near20_50hKaonError = 0;
    Double_t near20_50hhError = 0;
    Double_t away20_50hKaonError = 0;
    Double_t away20_50hhError = 0;
    //Double_t mid20_50hKaonError =(1.0/3.0)*TMath::Sqrt(TMath::Power(hKaondphi_20_50->GetBinError(8),2) + TMath::Power(hKaondphi_20_50->GetBinError(16),2) + TMath::Power(hKaondphi_20_50->GetBinError(1),2));
    Double_t mid20_50hKaonError = corrFit2_2050->GetParError(6);
    ...
    Double_t total20_50hKaonError = 0;
    Double_t total20_50hhError = 0;

    Double_t near20_50hKaonYield = hKaondphi_20_50->IntegralAndError(1,8,near20_50hKaonError, "width") - hKaonBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(1), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(8));
    //near20_50hKaonError = TMath::Sqrt(TMath::Power(near20_50hKaonError, 2) + TMath::Power(6.0*mid20_50hKaonError, 2));
    Double_t near20_50hhYield = hhdphi_20_50->IntegralAndError(1,8,near20_50hhError, "width") - hhBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(1), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(8));
    //near20_50hhError = TMath::Sqrt(TMath::Power(near20_50hhError, 2) + TMath::Power(6.0*mid20_50hhError, 2));
    Double_t away20_50hKaonYield = hKaondphi_20_50->IntegralAndError(9,16,away20_50hKaonError, "width") - hKaonBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(9), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(16));
    //away20_50hKaonError = TMath::Sqrt(TMath::Power(away20_50hKaonError, 2) + TMath::Power(8.0*mid20_50hKaonError, 2));
    Double_t away20_50hhYield = hhdphi_20_50->IntegralAndError(9,16,away20_50hhError, "width")- hhBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(9), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(16));
    //away20_50hhError = TMath::Sqrt(TMath::Power(away20_50hhError, 2) + TMath::Power(8.0*mid20_50hhError, 2));
    Double_t mid20_50hKaonYield = hKaonBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(1), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(16));
    mid20_50hKaonError = mid20_50hKaonError*16.0;
    Double_t mid20_50hhYield = hhBG_20_50->Integral(hKaondphi_20_50->GetXaxis()->GetBinLowEdge(1), hKaondphi_20_50->GetXaxis()->GetBinUpEdge(16));
    mid20_50hhError = mid20_50hhError*16.0;
    Double_t total20_50hKaonYield = hKaondphi_20_50->IntegralAndError(1, 16,total20_50hKaonError, "width");
    Double_t total20_50hhYield = hhdphi_20_50->IntegralAndError(1, 16,total20_50hhError, "width");
    Double_t jet20_50hKaon = hKaondphi_20_50->Integral(1, 16) - mid20_50hKaonYield;
    Double_t jet20_50hh = hhdphi_20_50->Integral(1, 16) - mid20_50hhYield;


    Double_t near2050 = near20_50hKaonYield/near20_50hhYield;
    Double_t near2050Er = near2050*TMath::Sqrt(TMath::Power(near20_50hKaonError/near20_50hKaonYield, 2) + TMath::Power(near20_50hhError/near20_50hhYield, 2));
    Double_t away2050 = away20_50hKaonYield/away20_50hhYield;
    Double_t away2050Er = away2050*TMath::Sqrt(TMath::Power(away20_50hKaonError/away20_50hKaonYield, 2) + TMath::Power(away20_50hhError/away20_50hhYield, 2));
    Double_t mid2050 = mid20_50hKaonYield/mid20_50hhYield;
    Double_t mid2050Er = mid2050*TMath::Sqrt(TMath::Power(mid20_50hKaonError/mid20_50hKaonYield, 2) + TMath::Power(mid20_50hhError/mid20_50hhYield, 2));
    Double_t total2050 = total20_50hKaonYield/total20_50hhYield;
    Double_t total2050Er = total2050*TMath::Sqrt(TMath::Power(total20_50hKaonError/total20_50hKaonYield, 2) + TMath::Power(total20_50hhError/total20_50hhYield, 2));

    TH1D *ratios2050 = new TH1D("ratios2050", "(h-#Kaon / h-h) Ratios", 4, 0, 4);
    ...
    paperfit2050->SetParameter(0, hKaonBG_20_50->GetParameter(0));

    //50-100 section
    TH1D* hhdphi_50_100 = getHisto("trig_4_8_assoc_2_4_cent_50_100_mixcorr_hKaon.root", "hh", "hh2D", "Eff_50_100", -1.2, 1.2, kBlue+2, 21);
    TH1D* hKaondphi_50_100 = getHisto(input_50_100, "hKaon", Form("RSUSsubhKaon2Dpeak%s", scaleSuffix.Data()), "Eff_50_100", -1.2, 1.2, kRed+2, 22);



    //scale for inv. mass range
    //hKaondphi_50_100->Scale(1.0/0.897); //wide mass
    //hKaondphi_50_100->Scale(1.0/0.803); //narrow mass

    TF1 *corrFit50100 = setupFit("corrFit50100", hhdphi_50_100, kBlue, 7, bgMethod);

    TF1 *corrFit2_50100 = setupFit("corrFit2_50100", hKaondphi_50_100, kRed, 7, bgMethod);

    hhdphi_50_100->Fit("corrFit50100", "R0");
    hKaondphi_50_100->Fit("corrFit2_50100", "R0");
    ...
    TF1 *hKaonBG_50_100 = new TF1("hKaonBG_50_100", "pol0(0)", -TMath::Pi()/2.0, 3.0*TMath::Pi()/2.0);
    hKaonBG_50_100->SetParLimits(0, 0.00001, 10000000.0);
    hKaonBG_50_100->SetParameter(0, 1.0*corrFit2_50100->GetParameter(6));
    hKaonBG_50_100->SetLineStyle(2);

    Double_t near50_100hKaonError = 0;
    Double_t near50_100hhError = 0;
    Double_t away50_100hKaonError = 0;
    Double_t away50_100hhError = 0;
    //Double_t mid50_100hKaonError =(1.0/3.0)*TMath::Sqrt(TMath::Power(hKaondphi_50_100->GetBinError(8),2) + TMath::Power(hKaondphi_50_100->GetBinError(16),2) + TMath::Power(hKaondphi_50_100->GetBinError(1),2));
    Double_t mid50_100hKaonError = corrFit2_50100->GetParError(6);
    ...
    Double_t total50_100hKaonError = 0;
    Double_t total50_100hhError = 0;

    Double_t near50_100hKaonYield = hKaondphi_50_100->IntegralAndError(1,8,near50_100hKaonError, "width") - hKaonBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(1), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(8));
    //near50_100hKaonError = TMath::Sqrt(TMath::Power(near50_100hKaonError, 2) + TMath::Power(6.0*mid50_100hKaonError, 2));
    Double_t near50_100hhYield = hhdphi_50_100->IntegralAndError(1,8,near50_100hhError, "width") - hhBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(1), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(8));
    //near50_100hhError = TMath::Sqrt(TMath::Power(near50_100hhError, 2) + TMath::Power(6.0*mid50_100hhError, 2));
    Double_t away50_100hKaonYield = hKaondphi_50_100->IntegralAndError(9,16,away50_100hKaonError, "width") - hKaonBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(9), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(16));
    //away50_100hKaonError = TMath::Sqrt(TMath::Power(away50_100hKaonError, 2) + TMath::Power(8.0*mid50_100hKaonError, 2));
    Double_t away50_100hhYield = hhdphi_50_100->IntegralAndError(9,16,away50_100hhError, "width")- hhBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(9), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(16));
    //away50_100hhError = TMath::Sqrt(TMath::Power(away50_100hhError, 2) + TMath::Power(8.0*mid50_100hhError, 2));
    Double_t mid50_100hKaonYield = hKaonBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(1), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(16));
    mid50_100hKaonError = mid50_100hKaonError*16.0;
    Double_t mid50_100hhYield = hhBG_50_100->Integral(hKaondphi_50_100->GetXaxis()->GetBinLowEdge(1), hKaondphi_50_100->GetXaxis()->GetBinUpEdge(16));
    mid50_100hhError = mid50_100hhError*16.0;
    Double_t total50_100hKaonYield = hKaondphi_50_100->IntegralAndError(1, 16,total50_100hKaonError, "width");
    Double_t total50_100hhYield = hhdphi_50_100->IntegralAndError(1, 16,total50_100hhError, "width");
    Double_t jet50_100hKaon = hKaondphi_50_100->Integral(1, 16) - mid50_100hKaonYield;
    Double_t jet50_100hh = hhdphi_50_100->Integral(1, 16) - mid50_100hhYield;


    Double_t near50100 = near50_100hKaonYield/near50_100hhYield;
    Double_t near50100Er = near50100*TMath::Sqrt(TMath::Power(near50_100hKaonError/near50_100hKaonYield, 2) + TMath::Power(near50_100hhError/near50_100hhYield, 2));
    Double_t away50100 = away50_100hKaonYield/away50_100hhYield;
    Double_t away50100Er = away50100*TMath::Sqrt(TMath::Power(away50_100hKaonError/away50_100hKaonYield, 2) + TMath::Power(away50_100hhError/away50_100hhYield, 2));
    Double_t mid50100 = mid50_100hKaonYield/mid50_100hhYield;
    Double_t mid50100Er = mid50100*TMath::Sqrt(TMath::Power(mid50_100hKaonError/mid50_100hKaonYield, 2) + TMath::Power(mid50_100hhError/mid50_100hhYield, 2));
    Double_t total50100 = total50_100hKaonYield/total50_100hhYield;
    Double_t total50100Er = total50100*TMath::Sqrt(TMath::Power(total50_100hKaonError/total50_100hKaonYield, 2) + TMath::Power(total50_100hhError/total50_100hhYield, 2));

    TH1D *ratios50100 = new TH1D("ratios50100", "(h-#Kaon / h-h) Ratios", 4, 0, 4);
    ...
    paperfit50100->SetParameter(0, hKaonBG_50_100->GetParameter(0));
    ...
    Double_t near0_100hKaonYield = near0_20hKaonYield + near20_50hKaonYield + near50_100hKaonYield;
    Double_t near0_100hKaonError = TMath::Sqrt((TMath::Power(near0_20hKaonError,2) + TMath::Power(near20_50hKaonError,2) + TMath::Power(near50_100hKaonError,2)));
    ...
    Double_t mid0_100hKaonYield = mid0_20hKaonYield + mid20_50hKaonYield + mid50_100hKaonYield;
    Double_t mid0_100hKaonError = TMath::Sqrt((TMath::Power(mid0_20hKaonError,2) + TMath::Power(mid20_50hKaonError,2) + TMath::Power(mid50_100hKaonError,2)));
    ...
    Double_t away0_100hKaonYield = away0_20hKaonYield + away20_50hKaonYield + away50_100hKaonYield;
    Double_t away0_100hKaonError = TMath::Sqrt((TMath::Power(away0_20hKaonError,2) + TMath::Power(away20_50hKaonError,2) + TMath::Power(away50_100hKaonError,2)));
    ...
    Double_t total0_100hKaonYield = total0_20hKaonYield + total20_50hKaonYield + total50_100hKaonYield;
    Double_t total0_100hKaonError = TMath::Sqrt((TMath::Power(total0_20hKaonError,2) + TMath::Power(total20_50hKaonError,2) + TMath::Power(total50_100hKaonError,2)));
    ...
    Double_t near0100 = (near0_20hKaonYield + near20_50hKaonYield + near50_100hKaonYield)/(near0_20hhYield + near20_50hhYield + near50_100hhYield);
    Double_t near0100Er = near0100*TMath::Sqrt((TMath::Power(near0_20hKaonError,2) + TMath::Power(near20_50hKaonError,2) + TMath::Power(near50_100hKaonError,2))/TMath::Power((near0_20hKaonYield + near20_50hKaonYield + near50_100hKaonYield), 2) + (TMath::Power(near0_20hhError,2) + TMath::Power(near20_50hhError,2) + TMath::Power(near50_100hhError,2))/TMath::Power((near0_20hhYield + near20_50hhYield + near50_100hhYield), 2));
    Double_t away0100 = (away0_20hKaonYield + away20_50hKaonYield + away50_100hKaonYield)/(away0_20hhYield + away20_50hhYield + away50_100hhYield);
    Double_t away0100Er = away0100*TMath::Sqrt((TMath::Power(away0_20hKaonError,2) + TMath::Power(away20_50hKaonError,2) + TMath::Power(away50_100hKaonError,2))/TMath::Power((away0_20hKaonYield + away20_50hKaonYield + away50_100hKaonYield), 2) + (TMath::Power(away0_20hhError,2) + TMath::Power(away20_50hhError,2) + TMath::Power(away50_100hhError,2))/TMath::Power((away0_20hhYield + away20_50hhYield + away50_100hhYield), 2));
    Double_t mid0100 = (mid0_20hKaonYield + mid20_50hKaonYield + mid50_100hKaonYield)/(mid0_20hhYield + mid20_50hhYield + mid50_100hhYield);
    Double_t mid0100Er = mid0100*TMath::Sqrt((TMath::Power(mid0_20hKaonError,2) + TMath::Power(mid20_50hKaonError,2) + TMath::Power(mid50_100hKaonError,2))/TMath::Power((mid0_20hKaonYield + mid20_50hKaonYield + mid50_100hKaonYield), 2) + (TMath::Power(mid0_20hhError,2) + TMath::Power(mid20_50hhError,2) + TMath::Power(mid50_100hhError,2))/TMath::Power((mid0_20hhYield + mid20_50hhYield + mid50_100hhYield), 2));
    Double_t total0100 = (total0_20hKaonYield + total20_50hKaonYield + total50_100hKaonYield)/(total0_20hhYield + total20_50hhYield + total50_100hhYield);
    Double_t total0100Er = total0100*TMath::Sqrt((TMath::Power(total0_20hKaonError,2) + TMath::Power(total20_50hKaonError,2) + TMath::Power(total50_100hKaonError,2))/TMath::Power((total0_20hKaonYield + total20_50hKaonYield + total50_100hKaonYield), 2) + (TMath::Power(total0_20hhError,2) + TMath::Power(total20_50hhError,2) + TMath::Power(total50_100hhError,2))/TMath::Power((total0_20hhYield + total20_50hhYield + total50_100hhYield), 2));

    printf("near020Er: %E\n", near020Er);
    printf("mid020Er: %E\n", mid020Er);
    printf("total0100Er: %E\n", total0100Er);
    printf("total020Er: %E\n", total020Er);
    printf("total0_20hKaonError: %E\n", total0_20hKaonError);
    TH1D *ratios0100 = new TH1D("ratios0100", "(h-#Kaon / h-h) Ratios", 4, 0, 4);
    ...
    Double_t near0_20hKaonSystError = 0.068;
    Double_t near20_50hKaonSystError = 0.077;
    Double_t near50_100hKaonSystError = 0.133;
    Double_t away0_20hKaonSystError = 0.097;
    Double_t away20_50hKaonSystError = 0.061;
    Double_t away50_100hKaonSystError = 0.111;
    Double_t mid0_20hKaonSystError = 0.017;
    Double_t mid20_50hKaonSystError = 0.013;
    Double_t mid50_100hKaonSystError = 0.037;
    Double_t total0_20hKaonSystError = 0.014;
    Double_t total20_50hKaonSystError = 0.012;
    Double_t total50_100hKaonSystError = 0.032;
    ...
    Double_t nearhKaonYieldArray[3] = {near50_100hKaonYield*300.0, near20_50hKaonYield*300.0, near0_20hKaonYield*300.0};
    Double_t nearhKaonYieldArrayErr[3] = {near50_100hKaonError*300.0, near20_50hKaonError*300.0, near0_20hKaonError*300.0};
    Double_t nearhKaonYieldArraySystErr[3] = {near50_100hKaonYield*near50_100hKaonSystError*300.0, near20_50hKaonYield*near20_50hKaonSystError*300.0, near0_20hKaonYield*near0_20hKaonSystError*300.0};
    Double_t awayhKaonYieldArray[3] = {away50_100hKaonYield*300.0, away20_50hKaonYield*300.0, away0_20hKaonYield*300.0};
    Double_t awayhKaonYieldArrayErr[3] = {away50_100hKaonError*300.0, away20_50hKaonError*300.0, away0_20hKaonError*300.0};
    Double_t awayhKaonYieldArraySystErr[3] = {away50_100hKaonYield*away50_100hKaonSystError*300.0, away20_50hKaonYield*away20_50hKaonSystError*300.0, away0_20hKaonYield*away0_20hKaonSystError*300.0};
    Double_t bulkhKaonYieldArray[3] = {mid50_100hKaonYield*100.0, mid20_50hKaonYield*100.0, mid0_20hKaonYield*100.0};
    Double_t bulkhKaonYieldArrayErr[3] = {mid50_100hKaonError*100.0, mid20_50hKaonError*100.0, mid0_20hKaonError*100.0};
    Double_t bulkhKaonYieldArraySystErr[3] = {mid50_100hKaonYield*mid50_100hKaonSystError*100.0, mid20_50hKaonYield*mid20_50hKaonSystError*100.0, mid0_20hKaonYield*mid0_20hKaonSystError*100.0};
    Double_t totalhKaonYieldArray[3] = {total50_100hKaonYield*100.0, total20_50hKaonYield*100.0, total0_20hKaonYield*100.0};
    Double_t totalhKaonYieldArrayErr[3] = {total50_100hKaonError*100.0, total20_50hKaonError*100.0, total0_20hKaonError*100.0};
    Double_t totalhKaonYieldArraySystErr[3] = {total50_100hKaonYield*total50_100hKaonSystError*100.0, total20_50hKaonYield*total20_50hKaonSystError*100.0, total0_20hKaonYield*total0_20hKaonSystError*100.0};
    ...
    //Double_t jet2UEhKaon[3] = {jet50_100hKaon/mid50_100hKaonYield, jet20_50hKaon/mid20_50hKaonYield, jet0_20hKaon/mid0_20hKaonYield};
    //Double_t jet2UEhh[3] = {jet50_100hh/mid50_100hhYield, jet20_50hh/mid20_50hhYield, jet0_20hh/mid0_20hhYield};
    Double_t jet2UEhKaon[3] = {mid50_100hKaonYield/total50_100hKaonYield, mid20_50hKaonYield/total20_50hKaonYield, mid0_20hKaonYield/total0_20hKaonYield};
    ...
    //jet vs UE ratios
    TGraph* jetratioshKaon = new TGraphErrors(3, multArray, jet2UEhKaon);
    jetratioshKaon->SetMarkerStyle(20);
    jetratioshKaon->SetMarkerSize(2);
    jetratioshKaon->SetMarkerColor(kCyan+1);
    jetratioshKaon->SetLineColor(kCyan+2);
    jetratioshKaon->SetLineWidth(2);
    jetratioshKaon->GetXaxis()->SetTitle("Multiplicity Percentile");
    jetratioshKaon->GetXaxis()->SetTitleSize(0.05);
    jetratioshKaon->GetXaxis()->SetLabelSize(0.04);
    jetratioshKaon->GetXaxis()->SetTitleOffset(0.9);
    jetratioshKaon->GetXaxis()->SetRangeUser(0.0, 100.0);
    jetratioshKaon->GetYaxis()->SetTitle("Yield Ratio #left(#frac{Near-Side}{Underlying Event}#right)");
    jetratioshKaon->GetYaxis()->SetTitleSize(0.04);
    jetratioshKaon->GetYaxis()->SetTitleOffset(1.5);
    jetratioshKaon->GetYaxis()->SetRangeUser(0.0002, 0.0035);
    ...
    for(int i =0; i<3; i++){
        ...
        ratioJetHist->SetBinContent(i+2, jet2UEhKaon[i]);
    }
    ...
    ratioNearHist->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    ratioBulkHist->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    ratiosNear->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    ratiosNearSyst->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    ratiosJetMultlegend->AddEntry(jetratioshKaon, "Jet/U.E. for (h-#Kaon)", "pl");
    ...
    text2->AddText("assoc: 2.0 < p_{T}^{#Kaon} < 4.0 GeV/c");
    ...
    //yield graphs
    TGraphErrors* yieldsNear = new TGraphErrors(3, multArray, nearhKaonYieldArray, multArrayErr, nearhKaonYieldArrayErr);
    ...
    yieldsNear->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    TGraphErrors* yieldsNearSyst = new TGraphErrors(3, multArray, nearhKaonYieldArray, multArraySystErr, nearhKaonYieldArraySystErr);
    ...
    yieldsNearSyst->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    TGraphErrors* yieldsAway = new TGraphErrors(3, multArray, awayhKaonYieldArray, multArrayErr, awayhKaonYieldArrayErr);
    ...
    TGraphErrors* yieldsAwaySyst = new TGraphErrors(3, multArray, awayhKaonYieldArray, multArraySystErr, awayhKaonYieldArraySystErr);
    ...
    TGraphErrors* yieldsBulk = new TGraphErrors(3, multArray, bulkhKaonYieldArray, multArrayErr, bulkhKaonYieldArrayErr);
    ...
    TGraphErrors* yieldsBulkSyst = new TGraphErrors(3, multArray, bulkhKaonYieldArray, multArraySystErr, bulkhKaonYieldArraySystErr);
    ...
    TGraphErrors* yieldsTot = new TGraphErrors(3, multArray, totalhKaonYieldArray, multArrayErr, totalhKaonYieldArrayErr);
    ...
    TGraphErrors* yieldsTotSyst = new TGraphErrors(3, multArray, totalhKaonYieldArray, multArrayErr, totalhKaonYieldArraySystErr);
    ...
    yieldshhNear->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    yieldshhNearSyst->GetYaxis()->SetTitle("Yield Ratio #left(#frac{h-#Kaon}{h-h}#right)");
    ...
    TH1D* jet2totalhKaon = (TH1D*)ratioNearHist->Clone("jet2totalhKaon");
    TH1D* jet2totalhh = (TH1D*)ratioNearHist->Clone("jet2totalhh");
    for(int i = 0; i < 3; i++){
        jet2totalhKaon->SetBinContent(i+2, (nearhKaonYieldArray[i] + awayhKaonYieldArray[i])/totalhKaonYieldArray[i]);
        jet2totalhh->SetBinContent(i+2, (nearhhYieldArray[i] + awayhhYieldArray[i])/totalhhYieldArray[i]);
    }

    jet2totalhKaon->SetLineColor(kMagenta+2);
    jet2totalhKaon->SetMarkerColor(kMagenta+2);
    jet2totalhKaon->GetYaxis()->SetTitle("(Jet/Total) pair-yield Ratio");
    ...
    gStyle->SetErrorX(0.5);
    jet2totalhKaon->Draw("AXIS");
    jet2totalhKaon->GetXaxis()->SetLabelOffset(999);
    jet2totalhKaon->GetXaxis()->SetTickSize(0.0);
    gPad->Update();
    newaxis = new TGaxis(gPad->GetUxmax(),
            gPad->GetUymin(),
            gPad->GetUxmin(),
    ...
    nearYieldMultlegend->AddEntry(yieldsNear, "(h-#Kaon) in Near Jet (x 300)", "pl");
    ...
    awayYieldMultlegend->AddEntry(yieldsAway, "(h-#Kaon) in Away Jet (x 300)", "pl");
    ...
    bulkYieldMultlegend->AddEntry(yieldsBulk, "(h-#Kaon) in UE (x 100)", "pl");
    ...
    totalYieldMultlegend->AddEntry(yieldsTot, "(h-#Kaon) pairs (x 100)", "pl");
    ...
    TH1D *doubleratios020 = new TH1D("doubleratios020", "(h-#Kaon / h-h) Double Ratios", 2, 0, 2);
    ...
    TH1D *doubleratios2050 = new TH1D("doubleratios2050", "(h-#Kaon / h-h) Double Ratios", 2, 0, 2);
    ...
    TH1D *doubleratios50100 = new TH1D("doubleratios50100", "(h-#Kaon / h-h) Double Ratios", 2, 0, 2);
    ...
    TH1D *doubleratios0100 = new TH1D("doubleratios0100", "(h-#Kaon / h-h) Double Ratios", 2, 0, 2);
    ...
    printf("\n\n");
    printf(" h-Kaon  YIELDS  ||     0 - 20     ||    20 - 50     ||    50 - 100    ||     0 - 100    ||\n");
    printf("=========================================================================================\n");
    printf("      NEAR     ||  %E  ||  %E  ||  %E  ||  %E  ||\n", near0_20hKaonYield, near20_50hKaonYield, near50_100hKaonYield, near0_100hKaonYield);
    printf("      MID      ||  %E  ||  %E  ||  %E  ||  %E  ||\n", mid0_20hKaonYield, mid20_50hKaonYield, mid50_100hKaonYield, mid0_100hKaonYield);
    printf("      AWAY     ||  %E  ||  %E  ||  %E  ||  %E  ||\n", away0_20hKaonYield, away20_50hKaonYield, away50_100hKaonYield, away0_100hKaonYield);
    printf("      TOTAL    ||  %E  ||  %E  ||  %E  ||  %E  ||\n", total0_20hKaonYield, total20_50hKaonYield, total50_100hKaonYield, total0_100hKaonYield);

    printf("\n\n");
    printf(" h-Kaon  ERRORS  ||     0 - 20     ||    20 - 50     ||    50 - 100    ||     0 - 100    ||\n");
    printf("=========================================================================================\n");
    printf("      NEAR     ||  %E  ||  %E  ||  %E  ||  %E  ||\n", near0_20hKaonError, near20_50hKaonError, near50_100hKaonError, near0_100hKaonError);
    printf("      MID      ||  %E  ||  %E  ||  %E  ||  %E  ||\n", mid0_20hKaonError, mid20_50hKaonError, mid50_100hKaonError, mid0_100hKaonError);
    printf("      AWAY     ||  %E  ||  %E  ||  %E  ||  %E  ||\n", away0_20hKaonError, away20_50hKaonError, away50_100hKaonError, away0_100hKaonError);
    printf("      TOTAL    ||  %E  ||  %E  ||  %E  ||  %E  ||\n", total0_20hKaonError, total20_50hKaonError, total50_100hKaonError, total0_100hKaonError);

    printf("\n\n");
    printf(" h-Kaon %%ERRORS ||     0 - 20     ||    20 - 50     ||    50 - 100    ||     0 - 100    ||\n");
    printf("=========================================================================================\n");
    printf("      NEAR     ||     %2.2f%%     ||     %2.2f%%     ||     %2.2f%%     ||     %2.2f%%     ||\n", 100*near0_20hKaonError/near0_20hKaonYield, 100*near20_50hKaonError/near20_50hKaonYield, 100*near50_100hKaonError/near50_100hKaonYield, 100*near0_100hKaonError/near0_100hKaonYield);
    printf("      MID      ||      %2.2f%%     ||      %2.2f%%     ||      %2.2f%%     ||      %2.2f%%     ||\n", 100*mid0_20hKaonError/mid0_20hKaonYield, 100*mid20_50hKaonError/mid20_50hKaonYield, 100*mid50_100hKaonError/mid50_100hKaonYield, 100*mid0_100hKaonError/mid0_100hKaonYield);
    printf("      AWAY     ||     %2.2f%%     ||     %2.2f%%     ||     %2.2f%%     ||     %2.2f%%     ||\n", 100*away0_20hKaonError/away0_20hKaonYield, 100*away20_50hKaonError/away20_50hKaonYield, 100*away50_100hKaonError/away50_100hKaonYield, 100*away0_100hKaonError/away0_100hKaonYield);
    printf("      TOTAL    ||      %2.2f%%     ||      %2.2f%%     ||      %2.2f%%     ||      %2.2f%%     ||\n", 100*total0_20hKaonError/total0_20hKaonYield, 100*total20_50hKaonError/total20_50hKaonYield, 100*total50_100hKaonError/total50_100hKaonYield, 100*total0_100hKaonError/total0_100hKaonYield);
    ...
    TH1D *yields020hKaon = new TH1D("yields020hKaonEff", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    yields020hKaon->GetXaxis()->SetBinLabel(1, "near-side");
    yields020hKaon->SetBinContent(1, near0_20hKaonYield);
    yields020hKaon->SetBinError(1, near0_20hKaonError);
    yields020hKaon->GetXaxis()->SetBinLabel(2, "mid");
    yields020hKaon->SetBinContent(2, mid0_20hKaonYield);
    yields020hKaon->SetBinError(2, mid0_20hKaonError);
    yields020hKaon->GetXaxis()->SetBinLabel(3, "away-side");
    yields020hKaon->SetBinContent(3, away0_20hKaonYield);
    yields020hKaon->SetBinError(3, away0_20hKaonError);
    yields020hKaon->GetXaxis()->SetBinLabel(4, "total");
    yields020hKaon->SetBinContent(4, total0_20hKaonYield);
    yields020hKaon->SetBinError(4, total0_20hKaonError);
    yields020hKaon->SetMarkerStyle(22);
    yields020hKaon->SetMarkerColor(kRed+2);
    yields020hKaon->SetLineColor(kRed+2);
    yields020hKaon->SetMarkerSize(2);
    yields020hKaon->SetLineWidth(2);

    TH1D *yields2050hKaon = new TH1D("yields2050hKaonEff", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    yields2050hKaon->GetXaxis()->SetBinLabel(1, "near-side");
    yields2050hKaon->SetBinContent(1, near20_50hKaonYield);
    yields2050hKaon->SetBinError(1, near20_50hKaonError);
    yields2050hKaon->GetXaxis()->SetBinLabel(2, "mid");
    yields2050hKaon->SetBinContent(2, mid20_50hKaonYield);
    yields2050hKaon->SetBinError(2, mid20_50hKaonError);
    yields2050hKaon->GetXaxis()->SetBinLabel(3, "away-side");
    yields2050hKaon->SetBinContent(3, away20_50hKaonYield);
    yields2050hKaon->SetBinError(3, away20_50hKaonError);
    yields2050hKaon->GetXaxis()->SetBinLabel(4, "total");
    yields2050hKaon->SetBinContent(4, total20_50hKaonYield);
    yields2050hKaon->SetBinError(4, total20_50hKaonError);
    yields2050hKaon->SetMarkerStyle(21);
    yields2050hKaon->SetMarkerColor(kBlue+2);
    yields2050hKaon->SetLineColor(kBlue+2);
    yields2050hKaon->SetMarkerSize(2);
    yields2050hKaon->SetLineWidth(2);

    TH1D *yields50100hKaon = new TH1D("yields50100hKaonEff", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    yields50100hKaon->GetXaxis()->SetBinLabel(1, "near-side");
    yields50100hKaon->SetBinContent(1, near50_100hKaonYield);
    yields50100hKaon->SetBinError(1, near50_100hKaonError);
    yields50100hKaon->GetXaxis()->SetBinLabel(2, "mid");
    yields50100hKaon->SetBinContent(2, mid50_100hKaonYield);
    yields50100hKaon->SetBinError(2, mid50_100hKaonError);
    yields50100hKaon->GetXaxis()->SetBinLabel(3, "away-side");
    yields50100hKaon->SetBinContent(3, away50_100hKaonYield);
    yields50100hKaon->SetBinError(3, away50_100hKaonError);
    yields50100hKaon->GetXaxis()->SetBinLabel(4, "total");
    yields50100hKaon->SetBinContent(4, total50_100hKaonYield);
    yields50100hKaon->SetBinError(4, total50_100hKaonError);
    yields50100hKaon->SetMarkerStyle(20);
    yields50100hKaon->SetMarkerColor(kGreen+2);
    yields50100hKaon->SetLineColor(kGreen+2);
    yields50100hKaon->SetMarkerSize(2);
    yields50100hKaon->SetLineWidth(2);

    TH1D *yields0100hKaon = new TH1D("yields0100hKaon", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    yields0100hKaon->GetXaxis()->SetBinLabel(1, "near-side");
    yields0100hKaon->SetBinContent(1, near0_100hKaonYield);
    yields0100hKaon->SetBinError(1, near0_100hKaonError);
    yields0100hKaon->GetXaxis()->SetBinLabel(2, "mid");
    yields0100hKaon->SetBinContent(2, mid0_100hKaonYield);
    yields0100hKaon->SetBinError(2, mid0_100hKaonError);
    yields0100hKaon->GetXaxis()->SetBinLabel(3, "away-side");
    yields0100hKaon->SetBinContent(3, away0_100hKaonYield);
    yields0100hKaon->SetBinError(3, away0_100hKaonError);
    yields0100hKaon->GetXaxis()->SetBinLabel(4, "total");
    yields0100hKaon->SetBinContent(4, total0_100hKaonYield);
    yields0100hKaon->SetBinError(4, total0_100hKaonError);
    yields0100hKaon->SetMarkerStyle(29);
    yields0100hKaon->SetMarkerColor(kViolet-1);
    yields0100hKaon->SetLineColor(kViolet-1);
    yields0100hKaon->SetMarkerSize(2);
    yields0100hKaon->SetLineWidth(2);


    TCanvas *yieldhKaonc = new TCanvas("yieldhKaon", "yieldhKaon",50, 50, 600, 600);
    yieldhKaonc->cd();
    yields2050hKaon->GetYaxis()->SetRangeUser(0.0000, 0.0040);
    yields2050hKaon->GetXaxis()->SetLabelSize(0.07);
    yields2050hKaon->Draw("P SAME");
    yields50100hKaon->GetXaxis()->SetLimits(0.05, 4.05);
    yields50100hKaon->Draw("P SAME");
    yields020hKaon->GetXaxis()->SetLimits(-0.05, 3.95);
    yields020hKaon->Draw("P SAME");
    yields0100hKaon->GetXaxis()->SetLimits(-0.1, 3.9);
    yields0100hKaon->Draw("P SAME");
    line->Draw("SAME");
    ratioslegend->Draw("SAME");


    TH1D *yields020hh = new TH1D("yields020hhEff", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    ...
    TH1D *yields50100hh = new TH1D("yields50100hhEff", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    ...
    TH1D *yields0100hh = new TH1D("yields0100hh", "h-#Kaon Per Trigger Yields", 4, 0, 4);
    ...
    TH1D *ratio = (TH1D*)hKaondphi_0_20->Clone("ratio");
    ratio->Divide(hhdphi_0_20);


    TLegend  *legend = new TLegend(0.3791, 0.1518, 0.8772, 0.2688);
    legend->SetMargin(0.15);
    legend->AddEntry(corrFit2, "Hadron-#Kaon(1020) Correlation", "l");
    ...
    TH1D* hKaondphi_0_20_syst = (TH1D*)hKaondphi_0_20->Clone("hKaondphi_0_20_syst");
    hKaondphi_0_20_syst->SetFillColor(kGray);
    TH1D* hKaondphi_20_50_syst = (TH1D*)hKaondphi_20_50->Clone("hKaondphi_20_50_syst");
    hKaondphi_20_50_syst->SetFillColor(kGray);
    TH1D* hKaondphi_50_100_syst = (TH1D*)hKaondphi_50_100->Clone("hKaondphi_50_100_syst");
    hKaondphi_50_100_syst->SetFillColor(kGray);
    ...
    for(int i = 1; i <= 16; i++){
        hKaondphi_0_20_syst->SetBinError(i, hKaondphi_0_20_syst->GetBinContent(i)*dphi020syst);
        hKaondphi_20_50_syst->SetBinError(i, hKaondphi_20_50_syst->GetBinContent(i)*dphi2050syst);
        hKaondphi_50_100_syst->SetBinError(i, hKaondphi_50_100_syst->GetBinContent(i)*dphi5080syst);
    ...
    hKaondphi_0_20->GetYaxis()->SetTitle("Per Trigger (h-#Kaon) Pairs");
    hKaondphi_0_20_syst->Draw("E2 SAME");
    hKaondphi_0_20->Draw("E0 X0 HIST SAME");
    //corrFit->Draw("SAME");
    //corrFit2->Draw("SAME");
    //hhBG->Draw("SAME");
    hKaonBG->Draw("SAME");
    ...
    //hKaondphi_0_20->Draw("E0 X0 SAME");
    // corrFit->Draw("SAME");
    corrFit2->Draw("SAME");
    //hhBG->Draw("SAME");
    //hKaonBG->Draw("SAME");
    ...
    hKaondphi_20_50_syst->Draw("E2 SAME");
    hKaondphi_20_50->Draw("E0 X0 HIST SAME");
    //corrFit2050->Draw("SAME");
    //corrFit2_2050->Draw("SAME");
    //hhBG_20_50->Draw("SAME");
    hKaonBG_20_50->Draw("SAME");
    text2050->Draw();
    text2->Draw();
    //legend->Draw();
    ...
    //hKaondphi_20_50->Draw("E0 X0 SAME");
    //corrFit2050->Draw("SAME");
    //corrFit2_2050->Draw("SAME");
    hhBG_20_50->Draw("SAME");
    //hKaonBG_20_50->Draw("SAME");
    ...
    hKaondphi_50_100_syst->Draw("E2 SAME");
    hKaondphi_50_100->Draw("E0 X0 HIST SAME");
    //corrFit50100->Draw("SAME");
    //corrFit2_50100->Draw("SAME");
    //hhBG_50_100->Draw("SAME");
    hKaonBG_50_100->Draw("SAME");
    text50100->Draw();
    text2->Draw();
    //legend->Draw();
    ...
    //hKaondphi_50_100->Draw("E0 X0 SAME");
    //corrFit50100->Draw("SAME");
    //corrFit2_50100->Draw("SAME");
    hhBG_50_100->Draw("SAME");
    //hKaonBG_50_100->Draw("SAME");
    ...
    //Set-up and Draw the hh and hkaon correlations on single canvases

    TH1D* hkaon020 = (TH1D*)hKaondphi_0_20->Clone("hkaon020");
    hkaon020->SetMarkerColor(kRed);
    hkaon020->SetMarkerSize(1.3);
    hkaon020->SetMarkerStyle(33);
    hkaon020->SetLineColor(kRed);
    hkaon020->Add(hKaonBG, -1.0);
    hkaon020->Scale(1.0/(2.4*hkaon020->GetXaxis()->GetBinWidth(1))); //scale by delta-eta and bin width

    TH1D* hkaon2050 = (TH1D*)hKaondphi_20_50->Clone("hkaon2050");
    hkaon2050->SetMarkerColor(kOrange);
    hkaon2050->SetLineColor(kOrange);
    hkaon2050->SetMarkerSize(1.3);
    hkaon2050->SetMarkerStyle(22);
    hkaon2050->Add(hKaonBG_20_50, -1.0);
    hkaon2050->Scale(1.0/(2.4*hkaon2050->GetXaxis()->GetBinWidth(1))); //scale by delta-eta and bin width

    TH1D* hkaon5080 = (TH1D*)hKaondphi_50_100->Clone("hkaon5080");
    hkaon5080->SetMarkerColor(kAzure);
    hkaon5080->SetMarkerSize(1.3);
    hkaon5080->SetMarkerStyle(23);
    hkaon5080->SetLineColor(kAzure);
    hkaon5080->Add(hKaonBG_50_100, -1.0);
    hkaon5080->Scale(1.0/(2.4*hkaon5080->GetXaxis()->GetBinWidth(1))); //scale by delta-eta and bin width
    ...
    TLegend* hkaonleg = new TLegend(0.456, 0.641, 0.613, 0.937);
    hkaonleg->SetBorderSize(0);
    hkaonleg->AddEntry(hkaon020, "0-20%", "lep");
    hkaonleg->AddEntry(hkaon2050, "20-50%", "lep");
    hkaonleg->AddEntry(hkaon5080, "50-80%", "lep");
    ...
    TPaveText* hkaontext = new TPaveText(0.181, 0.827, 0.356, 0.925, "NDC");
    hkaontext->SetBorderSize(0);
    hkaontext->SetFillColor(kWhite);
    hkaontext->AddText("h-#Kaon");
    ...
    TCanvas* chkaon = new TCanvas("chkaon", "chkaon", 50, 50, 550, 600);
    chkaon->cd();
    chkaon->SetMargin(0.12, 0.05, 0.1, 0.05);
    hkaon020->GetYaxis()->SetTitle("1/N_{trig} dN/d#Delta#varphi per #Delta#eta - constant (rad^{-1})");
    hkaon020->Draw("E0 X0 P SAME");
    hkaon2050->Draw("E0 X0 P SAME");
    hkaon5080->Draw("E0 X0 P SAME");
    fline->Draw("SAME");
    hkaontext->Draw();
    text2->Draw();
    hkaonleg->Draw();
...
*/
  ...
  /*TH1F* hhyieldSyst_0_20 = new TH1F("hhyieldSyst_0_20", "hhyieldSyst_0_20", 1000, 0.0, 10.0);
    ...
    TH1F* hkaonyieldSyst_0_20 = new TH1F("hkaonyieldSyst_0_20", "hkaonyieldSyst_0_20", 700, 3.0E-02, 10.0E-02);
    TH1F* hkaonyieldSyst_20_50 = new TH1F("hkaonyieldSyst_20_50", "hkaonyieldSyst_20_50", 600, 1.0E-02, 8.0E-02);
    TH1F* hkaonyieldSyst_50_100 = new TH1F("hkaonyieldSyst_50_100", "hkaonyieldSyst_50_100", 700, 0.5E-02, 7.5E-02);
    ...
    TH1F* hkaonnearyieldSyst_0_20 = new TH1F("hkaonnearyieldSyst_0_20", "hkaonnearyieldSyst_0_20", 800, 0.5E-03, 4.5E-03);
    TH1F* hkaonnearyieldSyst_20_50 = new TH1F("hkaonnearyieldSyst_20_50", "hkaonnearyieldSyst_20_50", 800, 0.5E-03, 4.5E-03);
    TH1F* hkaonnearyieldSyst_50_100 = new TH1F("hkaonnearyieldSyst_50_100", "hkaonnearyieldSyst_50_100", 800, 0.5E-03, 4.5E-03);
    ...
    TH1F* hkaonawayyieldSyst_0_20 = new TH1F("hkaonawayyieldSyst_0_20", "hkaonawayyieldSyst_0_20", 800, 0.5E-03, 4.5E-03);
    TH1F* hkaonawayyieldSyst_20_50 = new TH1F("hkaonawayyieldSyst_20_50", "hkaonawayyieldSyst_20_50", 800, 0.5E-03, 4.5E-03);
    TH1F* hkaonawayyieldSyst_50_100 = new TH1F("hkaonawayyieldSyst_50_100", "hkaonawayyieldSyst_50_100", 800, 0.5E-03, 4.5E-03);
    ...
    TH1F* hkaonbulkyieldSyst_0_20 = new TH1F("hkaonbulkyieldSyst_0_20", "hkaonbulkyieldSyst_0_20", 700, 3.0E-02, 10.0E-02);
    TH1F* hkaonbulkyieldSyst_20_50 = new TH1F("hkaonbulkyieldSyst_20_50", "hkaonbulkyieldSyst_20_50", 600, 1.0E-02, 8.0E-02);
    TH1F* hkaonbulkyieldSyst_50_100 = new TH1F("hkaonbulkyieldSyst_50_100", "hkaonbulkyieldSyst_50_100", 700, 0.5E-02, 7.5E-02);*/
    ...
    TH1F* hkaonyieldSyst_0_20 = new TH1F("hkaonyieldSyst_0_20", "hkaonyieldSyst_0_20", 500, 0.75, 1.25);
    TH1F* hkaonyieldSyst_20_50 = new TH1F("hkaonyieldSyst_20_50", "hkaonyieldSyst_20_50", 500, 0.75, 1.25);
    TH1F* hkaonyieldSyst_50_100 = new TH1F("hkaonyieldSyst_50_100", "hkaonyieldSyst_50_100", 500, 0.75, 1.25);
    ...
    TH1F* hkaonnearyieldSyst_0_20 = new TH1F("hkaonnearyieldSyst_0_20", "hkaonnearyieldSyst_0_20", 500, 0.75, 1.25);
    TH1F* hkaonnearyieldSyst_20_50 = new TH1F("hkaonnearyieldSyst_20_50", "hkaonnearyieldSyst_20_50", 500, 0.75, 1.25);
    TH1F* hkaonnearyieldSyst_50_100 = new TH1F("hkaonnearyieldSyst_50_100", "hkaonnearyieldSyst_50_100", 500, 0.75, 1.25);
    ...
    TH1F* hkaonawayyieldSyst_0_20 = new TH1F("hkaonawayyieldSyst_0_20", "hkaonawayyieldSyst_0_20", 500, 0.75, 1.25);
    TH1F* hkaonawayyieldSyst_20_50 = new TH1F("hkaonawayyieldSyst_20_50", "hkaonawayyieldSyst_20_50", 500, 0.75, 1.25);
    TH1F* hkaonawayyieldSyst_50_100 = new TH1F("hkaonawayyieldSyst_50_100", "hkaonawayyieldSyst_50_100", 500, 0.75, 1.25);
    ...
    TH1F* hkaonbulkyieldSyst_0_20 = new TH1F("hkaonbulkyieldSyst_0_20", "hkaonbulkyieldSyst_0_20", 500, 0.75, 1.25);
    TH1F* hkaonbulkyieldSyst_20_50 = new TH1F("hkaonbulkyieldSyst_20_50", "hkaonbulkyieldSyst_20_50", 500, 0.75, 1.25);
    TH1F* hkaonbulkyieldSyst_50_100 = new TH1F("hkaonbulkyieldSyst_50_100", "hkaonbulkyieldSyst_50_100", 500, 0.75, 1.25);
    ...
    hkaonyieldSyst_0_20->Fill(total0_20hKaonYield/stdtotal0_20);
    hkaonyieldSyst_20_50->Fill(total20_50hKaonYield/stdtotal20_50);
    hkaonyieldSyst_50_100->Fill(total50_100hKaonYield/stdtotal50_100);
    hkaonnearyieldSyst_0_20->Fill(near0_20hKaonYield/stdnear0_20);
    hkaonnearyieldSyst_20_50->Fill(near20_50hKaonYield/stdnear20_50);
    hkaonnearyieldSyst_50_100->Fill(near50_100hKaonYield/stdnear50_100);
    hkaonawayyieldSyst_0_20->Fill(away0_20hKaonYield/stdaway0_20);
    hkaonawayyieldSyst_20_50->Fill(away20_50hKaonYield/stdaway20_50);
    hkaonawayyieldSyst_50_100->Fill(away50_100hKaonYield/stdaway50_100);
    hkaonbulkyieldSyst_0_20->Fill(mid0_20hKaonYield/stdmid0_20);
    hkaonbulkyieldSyst_20_50->Fill(mid20_50hKaonYield/stdmid20_50);
    hkaonbulkyieldSyst_50_100->Fill(mid50_100hKaonYield/stdmid50_100);
...
*/
    ...
    hhdphi_0_20->Write();
    hKaondphi_0_20->Write();
    hhdphi_20_50->Write();
    hKaondphi_20_50->Write();
    hhdphi_50_100->Write();
    hKaondphi_50_100->Write();


    hkaonyieldSyst_0_20->Write();
    hkaonyieldSyst_20_50->Write();
    hkaonyieldSyst_50_100->Write();
    hkaonnearyieldSyst_0_20->Write();
    hkaonnearyieldSyst_20_50->Write();
    hkaonnearyieldSyst_50_100->Write();
    hkaonawayyieldSyst_0_20->Write();
    hkaonawayyieldSyst_20_50->Write();
    hkaonawayyieldSyst_50_100->Write();
    hkaonbulkyieldSyst_0_20->Write();
    hkaonbulkyieldSyst_20_50->Write();
    hkaonbulkyieldSyst_50_100->Write();
